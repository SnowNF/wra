...
while true; do
  ...
  chmod -R 777 /dev/dri/
  chmod -R 777 /dev/input/
  /bin/busybox su -l wra -c "XDG_RUNTIME_DIR=/tmp VK_ICD_FILENAMES=/usr/local/share/vulkan/icd.d/freedreno_icd.aarch64.json WLR_RENDERER=vulkan TU_FORCE_KGSL_DRM=1 labwc"
